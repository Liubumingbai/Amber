...
os.environ["REPLICATE_API_TOKEN"] = "r8_WDxiD8lcTepVxDJygMvfojLZBJK5Cr44EYT31"
app = Flask(__name__)
...
def index():
    if request.method == "POST":
        ...
        headers = {'Authorization': 'Token r8_WDxiD8lcTepVxDJygMvfojLZBJK5Cr44EYT31','Content-Type': 'application/json'}
